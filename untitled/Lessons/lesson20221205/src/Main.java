...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(accountsArray);
        System.out.println("------------ printClientsWithBalanceLessThan ");
        AccountsArray selectAccountsArray = accountsArray.getAccountsWithBalanceLessThan(1000);
        System.out.println(selectAccountsArray);
