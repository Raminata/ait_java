...
public class Main {
    public static void main(String[] args) {
        ...
        int[] array = {1, 4, -1, 9, 8, 6, 6, 5, 1, 5, 0};
        sort(array);
...
//8.  Написать метод, который принимает массив строк вида “Иван Иванов”, т.е.
//  имя и фамилия, а в качестве результата возвращает массив объектов
//  типа Student{String firstName, String lastName} .
    ...
    //9.  Дано целое число num. Необходимо написать метод, который посчитает сумму
    ...
    */
    ...
    //12. Дан массив целых чисел. Написать метод, который сортирует данный массив
    // в порядке возрастания. Использовать любой известный вам алгоритм сортировки.
